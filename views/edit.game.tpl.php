...
if(isset($_POST['update']))
{
	...
	$adress=$_POST['game_status'];
	$game_startdate=$_POST['game_startdate'];
	$game_max_players=$_POST['game_max_players'];
	$game_min_players=$_POST['phone'];
        $gamewinner = $_POST['winner'];
	
	
	$query1 = "UPDATE `game_information` SET `game_startdate` = '$game_startdate', `game_title` = '$game_title', `game_minplayers` = '$game_min_players', `game_winner` = '$gamewinner', `game_max_players` = '$game_max_players' WHERE `game_information`.`game_id` = 8;";
