	...
	<div class="card-body">
		<form method="post">
			<div class="form-group mb-3">
				...
				<input type="text" name="player_email" id="player_email" class="form-control" />
			</div>
			<div class="form-group mb-3">
				<label for="title">Player Email</label>
				<input type="text" name="player_nickname" id="player_nickname" class="form-control" />
			</div>
